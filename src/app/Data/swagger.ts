export const swagger = [

    {
        ...
        "conteudoItem": "Buscando todos os usuários:  nesse endpoint ele faz requisição de busca de todos os usuário        "
    },
    {
        "id": "2",
        "name": "GetById (User)",
        ...
        "conteudoItem": "Buscando um usuário pelo seu Id: nesse endpoint de apenas um usuário por meio da chave de autenticação.        "
    ...
    },
    {
        ...
        "conteudoItem": "Atualizando um cadastro: endpoint com a função de atualizar os dados de um usuário cadastrado, fazendo a busca e atualizando os dados de acordo com a chave de identificação do usuário cadastrado "
    },
    {
        "id": "4",
        ...
        "conteudoItem": "Imagem com o retorno da atualização do usuário solitado "
